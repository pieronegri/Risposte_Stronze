 ...
 */
public class Dashboard extends BottomFragmentIMPL {
...
private String TAG=Dashboard.class.getName();
    ...
    private static Dashboard newInstance(String param1, String param2) throws Exception {
        return BottomFragmentABS.newInstance(new Dashboard(), param1, param2);
    }

    static Dashboard newInstance() throws Exception {
        return newInstance("", "");
    }
