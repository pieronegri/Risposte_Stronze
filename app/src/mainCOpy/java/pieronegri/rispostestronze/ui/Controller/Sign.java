 ...
 */
public class Sign extends BottomFragmentIMPL {
    private static String TAG = Sign.class.getName();
    ...
    private static Sign newInstance(String param1, String param2) throws Exception {
        return newInstance(new Sign(), param1, param2);
    }

    static Sign newInstance() throws Exception {//package private
        return newInstance("", "");
    }
